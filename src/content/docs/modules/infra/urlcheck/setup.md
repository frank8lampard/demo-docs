---
title: Настройка мониторинга доступности
description: Инструкция по настройке мониторинга доступности веб-сервисов в GMonit — конфигурация docker-compose и агентов
---
