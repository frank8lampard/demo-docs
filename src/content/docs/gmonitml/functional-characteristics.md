---
title: Функциональные характеристики GMonitML
description: Описание функциональных характеристик платформы GMonitML — сбор, анализ и визуализация метрик MELT для мониторинга IT-систем
---
