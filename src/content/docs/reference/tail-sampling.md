...
description: Подход Infinite Tracing с tail-based сэмплированием в GMonit — оптимизация анализа и управление объёмом данных трассировки
---
...
и анализ таких транзакий, как длительные процессы или ошибки.
